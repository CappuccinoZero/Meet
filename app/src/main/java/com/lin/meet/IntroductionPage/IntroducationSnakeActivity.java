...
@EnableDragToClose
public class IntroducationSnakeActivity extends AppCompatActivity implements View.OnClickListener ,IntorductionContract.View {
    ...
    private void init(){
        ...
        more_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(IntroducationSnakeActivity.this,pair1,pair2,pair3);
                presenter.intoEncy(IntroducationSnakeActivity.this,id1,uri1,type1,compat);
            }
        });
        ...
        result_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!fixResult){
                    Toast.makeText(IntroducationSnakeActivity.this,"确认成功",Toast.LENGTH_SHORT).show();
        ...
        more_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(IntroducationSnakeActivity.this,pair1,pair2,pair3);
                presenter.intoEncy(IntroducationSnakeActivity.this,id2,uri2,type2,compat);
            }
        });
        ...
        more_3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(IntroducationSnakeActivity.this,pair1,pair2,pair3);
                presenter.intoEncy(IntroducationSnakeActivity.this,id3,uri3,type3,compat);
            }
        });
        ...
        pager.setPageTransformer(true,new IntroducationSnakeActivity.DepthPageTransformer());
        ...
        if(id==0){
            ...
            builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    if(!BmobUser.isLogin()){
                        Toast.makeText(IntroducationSnakeActivity.this,"需要登录",Toast.LENGTH_SHORT).show();
                        return;
                    }
                    showMapDialog(1);
                }
                ...
                Luban.with(this)
                        ...
                        .setCompressListener(new OnCompressListener() {
                            ...
                            public void onError(Throwable e) {
                                Toast.makeText(IntroducationSnakeActivity.this,"图片压缩失败",Toast.LENGTH_SHORT).show();
                            }
                        }).launch();
            }
        }else{
