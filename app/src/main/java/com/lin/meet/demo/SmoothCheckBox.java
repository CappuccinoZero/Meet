...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width,
                dp2px(getContext(), 0));
        isRect = ta.getBoolean(R.styleable.SmoothCheckBox_isRect,false);
        isTouch = ta.getBoolean(R.styleable.SmoothCheckBox_isTouch,true);
        ta.recycle();
    ...
    private void drawCenter(Canvas canvas) {
        ...
        if(!isRect)
            ...
            canvas.drawRect(mCenterPoint.x-radius,mCenterPoint.y-radius,
                mCenterPoint.x+radius,mCenterPoint.y+radius,mPaint);
    }
    ...
    private void drawBorder(Canvas canvas) {
        ...
        if(!isRect)
            ...
            canvas.drawRect(mCenterPoint.x-radius * mFloorScale,mCenterPoint.y-radius * mFloorScale,
                mCenterPoint.x+radius * mFloorScale,mCenterPoint.y+radius * mFloorScale,mFloorPaint);
    }
